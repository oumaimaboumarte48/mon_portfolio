    ...
    <div class="section" id="about">
        <div class="container">
            ...
            <div class="col-md-6 about-img-div">
                ...
                <img src="img/oo.jpg" width="400" class="img-responsive" alt="" align="right" data-aos="fade-right" data-aos-delay="0" />
            </div>
        </div>
    </div>
    <!-- ./about -->
                    ...
                    <div class="portfolio">
                        ...
                        <div class="no-padding portfolio_container clearfix" data-aos="fade-up"> 
                            ...
                            <div class="col-md-4 col-sm-6 site">
                                <a href="Corona-virus/Starter-file/dist/page d'acceuil.html" class="portfolio_item" target="_blank"> <img src="img/portfolio/corona.png" alt="image" class="img-responsive" />
                          ...
                          <div class="col-md-4 col-sm-6">
                                <a href="m2m services/index.php" class="portfolio_item" target="_blank"> <img src="img/jj.png" alt="image" class="img-responsive" />
                                    <div class="portfolio_item_hover">
                                        <div class="portfolio-border clearfix">
                                            <div class="item_info"> <span>Projet M2M SERVICES</span> <em>M2M SERVICES, EL Jadida, Maroc</em> </div>
                                        </div>
                                    </div>
                                </a>
                            </div>
                           ...
                           <div class="col-md-4 col-sm-6 css">
                                <a href="breifhtmlcss/index.html" class="portfolio_item" target="_blank"> <img src="img/portfolio/htmlcss.png" alt="image" class="img-responsive" />
                                    <div class="portfolio_item_hover">
                                        <div class="portfolio-border clearfix">
                            ...
                            <!-- single work -->
                            <div class="col-md-4 col-sm-6 css">
                                <a href="html_css_n2/index.html" class="portfolio_item" target="_blank"> <img src="img/portfolio/mmm.png" alt="image" class="img-responsive" />
                                    <div class="portfolio_item_hover">
                                        <div class="portfolio-border clearfix">
                            ...
                            <!-- single work -->
                            <div class="col-md-4 col-sm-6 css">
                                <a href="mon-site-web/index.html" class="portfolio_item" target="_blank"> <img src="img/portfolio/kkk.png" alt="image" class="img-responsive" />
                                    <div class="portfolio_item_hover">
                                        <div class="portfolio-border clearfix">
                                            <div class="item_info"> <span>Atelier HTML-CSS</span> <em>YOUCODE, Youssoufia, Maroc</em> </div>
                                        </div>
                            ...
                            <!-- single work -->
                            <div class="col-md-4 col-sm-6 js">
                                <a href="js1/mipro/index.html" class="portfolio_item" target="_blank"> <img src="img/portfolio/ooo.png" alt="image" class="img-responsive" />
                                    <div class="portfolio_item_hover">
                                        <div class="portfolio-border clearfix">
